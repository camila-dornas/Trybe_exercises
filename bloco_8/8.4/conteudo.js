...
// 2.Mostre na tela um relatório que diz em qual matéria o estudante foi melhor. Utilize um map e um reduce dentro dele.
const estudantes = [
    {
      nome: 'Jorge',
      sobrenome: 'Silva',
...
//   const bestEstudants = estudantes.filter((estudante) => (estudante.materias.nota > 60)).map((estudante) => {estudante['nome'] = estudante.nome, estudante['nota'] = estudante.materias.nota});

//   console.log(bestEstudants);